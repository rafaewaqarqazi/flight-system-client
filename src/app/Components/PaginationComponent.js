...
const PaginationComponent = ({pageNo, perPage, total, handlePageChange, handlePerPageChange}) => {
  ...
  return (
    <div className='d-flex justify-content-between  align-items-start flex-column-reverse align-items-sm-center flex-sm-row'>
      ...
      <div className='d-flex align-items-center'>
        <Dropdown isOpen={perPageDropdown} toggle={() => setPerPageDropdown(!perPageDropdown)}>
          <DropdownToggle
          ...
          <DropdownMenu>
            ...
            <DropdownItem onClick={() => handlePerPageChange(30)}>30</DropdownItem>
            <DropdownItem onClick={() => handlePerPageChange(40)}>40</DropdownItem>
          </DropdownMenu>
        </Dropdown>
        <div className='ml-2'>
